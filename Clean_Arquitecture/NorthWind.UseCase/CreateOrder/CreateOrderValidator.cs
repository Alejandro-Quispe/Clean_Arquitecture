...
namespace NorthWind.UseCase.CreateOrder
{
   public  class CreateOrderValidator : AbstractValidator<CreateOrderInputPort>
   {
        ...
        public CreateOrderValidator()
        {
            ...
            RuleFor(c => c.ShipCity).NotEmpty().Length(3).WithMessage("debe proporcionar al menos 3 caracteres de nombre de la ciudad");
            RuleFor(c => c.ShipCountry).NotEmpty().Length(3).WithMessage("debe proporcionar al menos 3 caracteres de nombre del pais");
